...
2. Use `augment()` to add model predictions to 
...
* Stabilization is useful for any type of exposure where the weights are unbounded. Weights like the ATO are bounded
