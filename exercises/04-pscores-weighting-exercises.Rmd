...
ggplot(d) +
  ...
  geom_histogram(bins = 50, alpha = 0.5, aes(x = extra_magic_morning_p0, y = - stat(count))) + 
  geom_histogram(bins = 50, aes(x = extra_magic_morning_p0, weight = ____, y = - stat(count)), fill = "blue", alpha = 0.5) + 
  ylab("count") + xlab("p") +
